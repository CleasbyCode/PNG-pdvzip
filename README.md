...
Embed a ***ZIP*** or ***JAR*** file within a ***PNG*** image, to create a ***tweetable*** and "[***executable***](https://github.com/CleasbyCode/PNG-pdvzip#extracting-your-embedded-files)" ***PNG*** polyglot file.  
...
![Demo Image](https://github.com/CleasbyCode/PNG-pdvzip/blob/main/demo_image/pzip_83973.png)  
...
***pdvzip*** uses different methods for [***storing***](https://github.com/CleasbyCode/PNG-pdvzip#png-image-requirements-for-arbitrary-data-preservation) and [***extracting***](https://github.com/CleasbyCode/PNG-pdvzip#extracting-your-embedded-files) embedded files within a ***PNG*** image.  
